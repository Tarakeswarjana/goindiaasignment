    ...
    <Layout>
      <div className='h-screen flex flex-col md:mx-0 mx-6 w-screen '>
        <div className='flex m-0 justify-center items-center md:bg-white '>
          <div
            className={`bg-slate-400 flex-1 md:basis-[60.00%] md:bg-white md:flex md:justify-center text-center pt-[30px] pb-[30px] font-bold text-2xl text-red-800 ${isActive ? 'bg-slate-800' : ''}`}
          ...
          <div
            className={`bg-slate-400 md:bg-white md:basis:[40%] flex-1 pt-8 pb-8 md:flex md:justify-center font-bold text-xl text-red-700  text-center ${!isActive ? 'bg-slate-800' : ''}`}
                  ...
                  <div key={id} className="w-100 flex mb-8  text-black rounded-lg shadow-slate-500 shadow-[0_6px_6px_6px] mr-11" >
                    ...
                    <div className=' basis-3/5 flex flex-col h-40'>
                      ...
                      <div className='flex justify-between  basis-1/3 mt-4' >
                        ...
                        <div className='max-w-12'>  <FontAwesomeIcon icon={faCommentAlt} />2k Comants</div>
